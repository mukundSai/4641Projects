...
public class BasicBehavior {
    ...
    public void QLearningExample(String outputPath){
        ...
        LearningAgent agent = new QLTutorial(domain, .99, hashingFactory, new ConstantValueFunction(), .5, .7);
        ((QLTutorial)agent).setLearningPolicy(new BoltzmannQPolicy((QLTutorial) agent,100000));
        //((QLTutorial)agent).setLearningPolicy(new GreedQPolicy((QLTutorial) agent));
