...
public class QLTutorial extends MDPSolver implements LearningAgent, QProvider, Planner {
    ...
    public GreedyQPolicy planFromState(State initialState) {
        ...
        int eCount = 0;
        do{
            this.runLearningEpisode(env, Integer.MAX_VALUE);
            eCount++;
        }while(eCount < 1 && maxQChangeInLastEpisode > 0);
