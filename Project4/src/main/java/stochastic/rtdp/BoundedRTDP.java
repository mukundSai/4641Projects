...
public class BoundedRTDP extends DynamicProgramming implements Planner {
	...
	/**
	 * Whether the current {@link DynamicProgramming} valueFunction reference points to the lower bound value function or the upper bound value function.
	...
	/**
	 * Sets what the {@link DynamicProgramming} valueFunction reference points to (the lower bound or upperbound) once a planning rollout is complete.
