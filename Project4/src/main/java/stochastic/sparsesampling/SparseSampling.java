package stochastic.sparsesampling;
...
import stochastic.dpoperator.BellmanOperator;
import stochastic.dpoperator.DPOperator;
 ...
 * <p>
 * This class requires a {@link HashableStateFactory}.
 * <p>
 ...
 * all the model implements {@link FullModel}). To set this class to compute the exact finite horizon value function, use the
...
public class SparseSampling extends MDPSolver implements QProvider, Planner {
	 ...
	 * only use the full transition dynamics if the number of possible transitions from each state is small and if the model implements {@link FullModel}
