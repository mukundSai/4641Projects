package stochastic.valueiteration;
...
public class ValueIteration extends DynamicProgramming implements Planner {
	...
	public ValueIteration(SADomain domain, double gamma, HashableStateFactory hashingFactory, double maxDelta, int maxIterations, boolean printData){
	...
	public void runVI(){
		...
		int i;
		//System.out.println("Value Iteration Rewards per Iteration");
		System.out.println("Iteration Num, Reward");
